...
const models = await assets.loadAll({
  ...
  // Quaternius nature pack (CC0): flat-colour stylized trees/rocks/bushes
  ...
  rockMossB: 'nature_q/Rock_Moss_4.glb',
  bushA: 'nature_q/Bush_1.glb',
  bushB: 'nature_q/Bush_2.glb',
  // Quaternius Modular Medieval Buildings (CC0): authored architecture that
  // replaces the primitive keep — real towers, gatehouse, banners, trim
  wall: 'castle_q/Wall.glb',
  wallTall: 'castle_q/TallWall.glb',
  wallEntrance: 'castle_q/TallWallEntrance.glb',
  towerLarge: 'castle_q/LargeTower.glb',
  towerPointy: 'castle_q/PointyTower.glb',
  tower: 'castle_q/Tower.glb',
  towerSmall: 'castle_q/SmallTower.glb',
  watchtower: 'castle_q/WatchTowerWRoof.glb',
  banner: 'castle_q/Banner.glb',
  ...
  flowerClump: 'flora_q/Flowers.glb',
  plantA: 'flora_q/Plant_1.glb',
  plantB: 'flora_q/Plant_3.glb',
...
window.__game = {
  ...
  setCamDistance(d) { tpCamera.dist = d; tpCamera.targetDist = d; },
  hidePlayer(h) { player.group.visible = !h; },
